...
public class EntreesPanel extends JPanel {
    ...
    private static final String[][] ENTREES = {
        ...
        {"Shrimp Scampi", "Shrimp sauteed in garlic butter sauce.", "19.99", "src/restaurant-ordering-system/src/panels/assets/images/Shrimp Scampi.jpg"},
        ...
        {"Lamb Chops", "Grilled lamb chops with rosemary.", "22.99", "src/restaurant-ordering-system/src/panels/assets/images/Lamb Chops.jpg"},
    ...
    private void initializeEntreesPanel() {
        ...
        addSubHeader("Vegetarian", entreesPanel);
        addMenuItem("Vegetable Stir Fry", "Fresh vegetables in a savory sauce.", 12.99, "src/restaurant-ordering-system/src/panels/assets/images/Vegetable Stir Fry.jpg", entreesPanel);
        addMenuItem("Pasta Primavera", "Pasta with fresh vegetables and light sauce.", 14.99, "src/restaurant-ordering-system/src/panels/assets/images/Pasta Primavera.jpg", entreesPanel);
        addMenuItem("Eggplant Parmesan", "Breaded eggplant with marinara and cheese.", 13.99, "src/restaurant-ordering-system/src/panels/assets/images/Eggplant Parmesan.jpg", entreesPanel);
        addMenuItem("Tofu Stir Fry", "Tofu with mixed vegetables in a savory sauce.", 11.99, "src/restaurant-ordering-system/src/panels/assets/images/Tofu Stir Fry.jpg", entreesPanel);

        addSubHeader("Non-Vegetarian", entreesPanel);
        addMenuItem("Grilled Chicken", "Juicy grilled chicken breast.", 15.99, "src/restaurant-ordering-system/src/panels/assets/images/Grilled Chicken.jpg", entreesPanel);
        addMenuItem("Beef Steak", "Tender beef steak cooked to perfection.", 20.99, "src/restaurant-ordering-system/src/panels/assets/images/Beef Steak.jpg", entreesPanel);
        addMenuItem("Chicken Alfredo", "Creamy Alfredo sauce with grilled chicken.", 16.99, "src/restaurant-ordering-system/src/panels/assets/images/Chicken Alfredo.jpg", entreesPanel);
        addMenuItem("BBQ Ribs", "Slow-cooked ribs with BBQ sauce.", 21.99, "src/restaurant-ordering-system/src/panels/assets/images/BBQ Ribs.jpg", entreesPanel);
        addMenuItem("Lamb Chops", "Grilled lamb chops with rosemary.", 22.99, "src/restaurant-ordering-system/src/panels/assets/images/Lamb Chops.jpg", entreesPanel);

        addSubHeader("Seafood", entreesPanel);
        addMenuItem("Salmon Fillet", "Grilled salmon with lemon butter.", 18.99, "src/restaurant-ordering-system/src/panels/assets/images/Salmon Fillet.jpg", entreesPanel);
        addMenuItem("Shrimp Scampi", "Shrimp sauteed in garlic butter sauce.", 19.99, "src/restaurant-ordering-system/src/panels/assets/images/Shrimp Scampi.jpg", entreesPanel);
        addMenuItem("Crab Cakes", "Golden crab cakes with tartar sauce.", 17.99, "src/restaurant-ordering-system/src/panels/assets/images/Crab Cakes.jpg", entreesPanel);
    }

    private void addMenuItem(String name, String description, double cost, String imagePath, JPanel panel) {
    ...
    private void addSubHeader(String title, JPanel panel) {
        JLabel subHeader = new JLabel(title, SwingConstants.LEFT);
